    ...
    axios.get(`http://localhost:5000/articles/code/${code}`)
      .then(response => {
        ...
        axios.get(`http://localhost:5000/famille/${article.libelleFamille}`)
          ...
          .catch(error => {
            console.error("Erreur de chargement des détails de la famille", error);
          });
      })
      .catch(error => {
          ...
          <div className="document-form">
            <Box sx={{ display: "flex", justifyContent: "space-between", gap: 2 }}>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <TextField label="Réf. BCC" fullWidth margin="normal" size="small" />
                <TextField label="Point de Vente" fullWidth margin="normal" size="small" />
                <TextField label="Type de Paiement" fullWidth margin="normal" size="small" />
                <TextField label="Commentaire" fullWidth margin="normal" multiline rows={4} size="small" />
              </Box>
            </Box>
              ...
              <tbody>
                {lignes.map((ligne, index) => (
                  <tr key={index}>
                    ...
                    <td> <Button onClick={() => supprimerLigne(index)} size="small">Supprimer</Button></td>
            ...
            <Dialog open={openModal} onClose={handleCloseModal}>
              ...
              <DialogContent>
                <TextField label="Numéro" fullWidth value={numDocument} onChange={(e) => setNumDocument(e.target.value)} margin="normal" size="small" />
                <TextField label="Date" type="date" fullWidth value={dateDocument} onChange={(e) => setDateDocument(e.target.value)} margin="normal" InputLabelProps={{ shrink: true }} size="small" />
                <FormControl fullWidth margin="normal">
                  <InputLabel>Type de document</InputLabel>
                  <Select value={typeDocument} onChange={(e) => setTypeDocument(e.target.value)} size="small">
